    ...
    "models_(json)": [
        {
            "schema1": [
                {
                    "Address": "<class 'smoke_mirrors.app.helper_funcs.JsonSchemaClass'>"
                },
                {
                    "New_Address1": "<class 'smoke_mirrors.app.helper_funcs.JsonSchemaClass'>"
                },
                {
                    "New_Address2": "<class 'smoke_mirrors.app.helper_funcs.JsonSchemaClass'>"
                },
                {
                    "New_Address3": "<class 'smoke_mirrors.app.helper_funcs.JsonSchemaClass'>"
                },
                {
                    "New_Address4": "<class 'smoke_mirrors.app.helper_funcs.JsonSchemaClass'>"
                },
                {
                    "USER": "<class 'smoke_mirrors.app.helper_funcs.JsonSchemaClass'>"
                }
            ]
        },
        {
