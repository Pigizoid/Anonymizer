...
def test_check_generation_constraints_expect_alternate():
    ...
    assert return_value["constr_strip_whitespace"]["strip_whitespace"] is None
    assert return_value["constr_to_upper"]["to_upper"] is None
    assert return_value["constr_to_lower"]["to_lower"] is None
    assert return_value["constr_strict"]["strict"] is None
    ...
    assert return_value["constr_allow_inf_nan"]["allow_inf_nan"] is None
    assert return_value["constr_max_digits"]["max_digits"] is None
    assert return_value["constr_decimal_places"]["decimal_places"] is None
