...
test_Address_4 = JsonSchemaClass(
    {
        ...
        "properties": {
            ...
            "extra": {"$ref": "#/$defs/test_Address_3"},
        },
        "required": ["name", "phone_number", "social_security_number", "extra"],
...
Constraints6 = JsonSchemaClass(
    {
        "properties": {
            ...
            "constr_to_upper": {"title": "Constr To Upper", "type": "string"},
            "constr_to_lower": {"title": "Constr To Lower", "type": "string"},
            "constr_strict": {"title": "Constr Strict", "type": "string"},
            "constr_default": {
                "default": "AAA",
                "title": "Constr Default",
                "type": "string",
            },
            "constr_annotation": {"title": "Constr Annotation", "type": "string"},
            "constr_min_length": {
                "minLength": 5,
            ...
            "constr_ge": {"minimum": 5, "title": "Constr Ge", "type": "integer"},
            "constr_le": {"maximum": 5, "title": "Constr Le", "type": "integer"},
            "constr_multiple_of": {
                "multipleOf": 5,
            ...
            "constr_required": {"title": "Constr Required", "type": "string"},
        },
        "required": [
            "constr_strict",
            "constr_annotation",
...
Constraints = JsonSchemaClass(
    {
        "$defs": {
            "ConstraintsNested": {
                "properties": {
                    "test_none": {"title": "Test None", "type": "null"},
                    "test_basic": {"title": "Test Basic", "type": "string"},
                    "test_pattern": {
                        "pattern": "^a$",
                        "title": "Test Pattern",
                        "type": "string",
        ...
        "properties": {
            ...
            "constr_required": {"title": "Constr Required", "type": "string"},
            "nested_1": {"$ref": "#/$defs/ConstraintsNested"},
            "nested_2": {"$ref": "#/$defs/ConstraintsNested"},
        },
        "required": [
            "constr_strict",
            "constr_annotation",
