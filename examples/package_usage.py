    ...
    "paths": {
        "/": {
            "get": {
                ...
                "operationId": "get_all_tasks__get",
                "responses": {
                    "200": {
                        ...
                        "content": {
                            "application/json": {
                                "schema": {
                                    ...
                                    "type": "array",
                                    "title": "Response Get All Tasks  Get",
                                }
                            }
                        },
                    }
            ...
            "delete": {
                ...
                "operationId": "delete_all_tasks__delete",
                "responses": {
                    "200": {
                        "description": "Successful Response",
        ...
        "/{user_id}": {
            "get": {
                ...
                "operationId": "get_tasks_by_user_id__user_id__get",
                "parameters": [
                    {
                        "name": "user_id",
                        "in": "path",
                        ...
                        "content": {
                            "application/json": {
                                "schema": {
                                    "type": "array",
                                    "items": {"$ref": "#/components/schemas/Task"},
                                    "title": "Response Get Tasks By User Id  User Id  Get",
                                }
                            }
                        },
                    },
        ...
        "/{id}": {
            ...
            "patch": {
                "tags": ["Tasks"],
                "summary": "Update Task",
                "operationId": "update_task__id__patch",
                "parameters": [
                    {
                        "name": "id",
                        "in": "path",
            ...
            "delete": {
                "tags": ["Tasks"],
                "summary": "Delete Task",
                "operationId": "delete_task__id__delete",
                "parameters": [
                    {
                        "name": "id",
                        "in": "path",
...
schema = {
    ...
    "title": "Root Schema Stress Test",
    "description": "A schema with many anchors, ids, and references for stress testing.",
    "type": "object",
    "$defs": {
        "stringDef": {
            "$id": "http://example.com/defs/string.schema.json",
            "$anchor": "stringAnchor",
            "type": "string",
            "minLength": 1,
        },
        "numberDef": {
            "$id": "http://example.com/defs/number.schema.json",
            "$anchor": "numAnchor",
            "type": "number",
            "minimum": 0,
        },
        "nested": {
            "$id": "http://example.com/defs/nested.schema.json",
            "type": "object",
            "properties": {
                "child": {"$ref": "string.schema.json#stringAnchor"},
                "value": {"$ref": "number.schema.json#numAnchor"},
            },
            "required": ["child", "value"],
        },
    },
    "properties": {
        "name": {"$ref": "#/$defs/stringDef"},
        "age": {"$ref": "http://example.com/defs/number.schema.json"},
        "profile": {"$ref": "#/$defs/nested"},
        "aliases": {
            "type": "array",
            "items": {
                "$ref": "http://example.com/defs/string.schema.json#stringAnchor"
            },
        },
        "meta": {
            "$id": "http://example.com/props/meta.schema.json",
            "type": "object",
            "properties": {
                "createdAt": {"type": "string", "format": "date-time"},
                "tags": {
                    "type": "array",
                    "items": {"$ref": "/defs/string.schema.json"},
                },
            },
        },
    },
...
def test_URI_schema():
    ...
    print("URI Model | JSON output data:", val, "\n")
